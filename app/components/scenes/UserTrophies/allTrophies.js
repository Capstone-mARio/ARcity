...
export const allTrophies= [
  { name: 'Trophy', owned: false, cost: 200, trophy: trophyTrophy, shadow: trophyShadow},
  { name: 'Suitcase', owned: false, cost: 100, trophy: suitcaseTrophy, shadow: suitcaseShadow },
  { name: 'Coin', owned: false, cost: 1, trophy: coinTrophy, shadow: coinShadow},
  { name: 'Fireball', owned: false, cost: 500, trophy: fireballTrophy, shadow: fireballShadow },
  { name: 'Cube' , owned: false, cost: 500, trophy: cubeTrophy, shadow: cubeShadow},
  { name: 'Mug', owned: false, cost: 1000, trophy: mugTrophy, shadow: mugShadow},
  { name: 'Car', owned: false, cost: 10000, trophy: carTrophy, shadow: carShadow },
  { name: 'Guitar' , owned: false, cost: 5000, trophy: guitarTrophy, shadow: guitarShadow},
  { name: 'Phone', owned: false, cost: 8000, trophy: phoneTrophy, shadow: phoneShadow },
  { name: 'Cone' , owned: false, cost: 100000, trophy: coneTrophy, shadow: coneShadow},
]